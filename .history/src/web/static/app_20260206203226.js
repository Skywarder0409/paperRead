...
(function () {
    ...
    btnRestart.addEventListener("click", async () => {
        ...
        try {
            ...
            document.body.innerHTML = '<div style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100vh;color:#6b5c4d;font-size:18px;"><div>正在重启服务器...</div><div style="font-size:14px;margin-top:10px;color:#9a8b7a;">页面将在 5 秒后自动刷新</div></div>';
            setTimeout(() => {
