...
class VisionOCREngine:
    ...
    def process_all_pages(
        ...
        logger.info("💡 提示: 请确保开启了环境变量 OLLAMA_NUM_PARALLEL=%d 以获得最佳速度", parallel_threads)
        ...
        def _worker_wrapper(img_path, page_num):
            ...
            return content, threading.current_thread().name, duration
        ...
        with ThreadPoolExecutor(max_workers=parallel_threads) as executor:
            ...
            for future in as_completed(future_to_page):
                ...
                try:
                    ...
                    if show_progress:
                        logger.info(
                            "✅ [%d/%d] 页面 %d 完成 | 耗时: %.1fs | 线程: %s | 并行总数: %d", 
